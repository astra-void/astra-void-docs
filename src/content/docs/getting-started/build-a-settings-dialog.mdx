...
[Select](/components/select/), [Dialog](/components/dialog/), and [Motion](/components/motion/)
fit together.
...
- [Motion](/components/motion/) owns animation policy and shared transition behavior.
...
<div class="home-links">
  ...
  <LinkCard
    ...
    description="Presence, response, feedback, and reduced-motion policy."
  />
  <LinkCard
    title="Text Field"
...
- Put [Motion](/components/motion/) policy there too, so primitives share reduced-motion and transition behavior.
