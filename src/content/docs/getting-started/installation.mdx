...
You can add several primitives at once, or pull in a curated preset — `overlay` bundles popover, tooltip, dialog, and toast, while `form` bundles checkbox, radio-group, switch, text-field, and textarea. The full preset list lives in the [CLI reference](/lattice-ui/reference/cli/).
