...
Use this guide after [Build a Settings Dialog](/getting-started/build-a-settings-dialog/).
That tutorial shows the practical flow first; this page explains the design rules behind it.
