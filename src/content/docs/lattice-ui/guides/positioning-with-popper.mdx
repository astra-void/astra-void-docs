...
Anchored surfaces — popovers, menus, selects, tooltips, comboboxes — face the same problem: place a
floating panel next to an anchor so it stays on the requested side, lines up as asked, and never
