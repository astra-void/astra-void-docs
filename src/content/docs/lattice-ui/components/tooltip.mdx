...
<PropTable
  rows={[
    ...
    { name: "transition", type: "MotionConfig", description: "Reveal/exit motion. None by default; pass createCanvasGroupPopperEntranceRecipe(placement) keyed to the resolved placement." },
