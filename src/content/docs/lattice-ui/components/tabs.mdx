...
selected trigger is removed or disabled — `Root` resolves a replacement. It falls back to the first
enabled trigger, or to the next enabled one after whichever was last selected. This keeps a valid
