...
<PropTable
  rows={[
    ...
    { name: "transition", type: "PresenceMotionConfig", description: "Overrides the default placement-aware reveal/exit recipe. Build variants with createCanvasGroupPopperEntranceRecipe or createPopperEntranceRecipe from @lattice-ui/react-motion." },
