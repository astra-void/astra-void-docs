...
Lattice primitives are headless — they give you behavior and leave the pixels to you. `@lattice-ui/style` is the package that fills the visual half, and it gives you exactly two styling tools:
...
import { mergeSx, type Sx } from "@lattice-ui/style";
...
import { createRecipe, useTheme } from "@lattice-ui/style";
