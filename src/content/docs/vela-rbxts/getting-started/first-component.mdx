...
Every offset is wrapped in `__VelaRem.scale`. That is [rem](/vela-rbxts/guides/theming/#rem). The
...
Read [How it works](/vela-rbxts/getting-started/how-it-works/) for how the transformer fits into an
