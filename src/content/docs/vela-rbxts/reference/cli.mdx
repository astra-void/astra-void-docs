...
This is an **alternative** to [the transformer](/vela-rbxts/getting-started/installation/#choose-how-vela-runs),
...
Pin `typescript@5.9.3`, as [installation](/vela-rbxts/getting-started/installation/#install-the-packages)
