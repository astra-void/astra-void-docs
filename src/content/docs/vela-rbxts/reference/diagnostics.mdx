---
title: Diagnostics
description: Every diagnostic code Vela can emit at 0.4.1, how it reaches your build or editor, and the caveats that make some of them easy to miss.
product: vela-rbxts
section: reference
sidebar:
  order: 30
...
elsewhere in the file. Since 0.4.1 `tsx-parse-failed` is anchored too, and its message names the
line and column: `Failed to parse TSX input at line 2, column 53: Unexpected token …`.
