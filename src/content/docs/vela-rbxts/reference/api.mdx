...
module that needed it; 0.12.0 published it, split into the neutral core and one host per target, and
turned the inlining into an import.

All packages are versioned in lockstep at **0.12.0**, including the VS Code extension. There is no
