...
project set up from scratch. The registry holds twenty-one components. What has *not* been checked
is how most of them look.
...
parses the entry, asks, and writes it — see [wiring a provider](/facet/reference/cli/#wiring-a-provider).
