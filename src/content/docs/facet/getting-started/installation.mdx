...
[registry format reference](/facet/reference/registry-format/#validation-rules) has the rule.
</Details>
...
happens in `add` rather than `init` — see [wiring a provider](/facet/reference/cli/#wiring-a-provider).
</Details>
