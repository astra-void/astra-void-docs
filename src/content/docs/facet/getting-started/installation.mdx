...
currently at **0.3.0**. You install the CLI; it installs the other two at the moment they are
actually needed.
...
- [Scope and status](/facet/getting-started/scope-and-status/) — what exists at 0.3.0, and what does not.
