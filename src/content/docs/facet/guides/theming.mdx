...
The previews on this site show it: flipping the docs' light/dark toggle **reloads the frame against a different build** rather than repainting the running one.
</Callout>
