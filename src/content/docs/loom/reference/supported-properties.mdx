...
Everything below describes loom `0.10.0`: the JSX intrinsics in `@loom-dev/react`, the DOM mapping in
...
It is a description of loom `0.10.0`, not a compatibility promise. The project is pre-1.0 and rows
