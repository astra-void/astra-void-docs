 ...
 * itself and the `@vela-rbxts/*` scope — so a single number describes the whole
 * toolchain. Pages that print it import from here instead of hardcoding a
 * literal, which is how the landing page came to advertise 0.4.1 while
 * `release-notes.mdx` had `0.10.0` as the current release.
 *
...
export const VELA_VERSION = "0.11.0"

/** Pre-1.0 marker shown next to the version. */
export const VELA_STABILITY = "pre-1.0"

/** `vela-rbxts · v0.11.0 · pre-1.0` — the landing page badge. */
