...
const tscPath = path.join(docsRoot, "node_modules", "typescript", "lib", "tsc.js");

if (!fs.existsSync(latticePlaygroundTsconfig)) {
  console.error(`Missing lattice-ui playground tsconfig: ${latticePlaygroundTsconfig}`);
  process.exit(1);
}
...
const child = spawn(process.execPath, [tscPath, "-p", examplesTsconfig, "--pretty", "false"], {
  cwd: docsRoot,
  stdio: "inherit",
});
